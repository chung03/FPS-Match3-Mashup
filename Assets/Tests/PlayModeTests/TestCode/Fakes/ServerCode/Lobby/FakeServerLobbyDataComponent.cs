...
public class FakeServerLobbyDataComponent : MonoBehaviour
{
	...
	public void AddPlayerToTeam()
	{
		...
		{
			Debug.Log("FakeServerLobbyDataComponent::HandleConnections SHOULD NOT BE IN THIS STATE! TEAMS ARE FULL BUT THERE ARE LESS THAN MAX NUMBER OF PLAYERS CONNECTED? NOT POSSIBLE. numTeam1Players = " + numTeam1Players + ", numTeam2Players = " + numTeam2Players);
		}
	...
	public void RemovePlayerFromTeam(int index)
	{
		...
		{
			Debug.Log("FakeServerLobbyDataComponent::HandleConnections Removing a player not one team 1 or team 2. playerList[i].team = " + m_PlayerList[index].team);
		}
	...
	private int ChangePlayerReady(int index, byte[] bytes, int playerIndex)
	{
		...
		Debug.Log("FakeServerLobbyDataComponent::ChangePlayerReady Player " + m_PlayerList[playerIndex].playerID + " ready state set to " + m_PlayerList[playerIndex].isReady);
	...
	private int ChangePlayerTeam(int index, byte[] bytes, int playerIndex)
	{
		if (m_PlayerList[playerIndex].team == 0 && numTeam2Players < 3)
		{
			...
			Debug.Log("FakeServerLobbyDataComponent::ChangePlayerTeam Client " + m_PlayerList[playerIndex].playerID + " team was set to 1");
		}
		else if (m_PlayerList[playerIndex].team == 1 && numTeam1Players < 3)
		{
			...
			Debug.Log("FakeServerLobbyDataComponent::ChangePlayerTeam Client " + m_PlayerList[playerIndex].playerID + " team was set to 0");
		}
		else
		{
			Debug.Log("FakeServerLobbyDataComponent::ChangePlayerTeam SHOULD NOT HAPPEN! Player " + m_PlayerList[playerIndex].playerID + " tried to change teams but something strange happened. players team = " + m_PlayerList[playerIndex].team + ", numTeam1Players = " + numTeam1Players + ", numTeam2Players = " + numTeam2Players);
		}
	...
	{
		Debug.Log("FakeServerLobbyDataComponent::GetPlayerID Client " + playerIndex + " sent request for its ID");
	...
	private int ChangePlayerName(int index, byte[] bytes, int playerIndex)
	{
		...
		Debug.Log("FakeServerLobbyDataComponent::ChangePlayerName Client " + playerIndex + " name set to " + m_PlayerList[playerIndex].name);
	...
	{
		Debug.Log("FakeServerLobbyDataComponent::HeartBeat Client " + playerIndex + " sent heartbeat");
